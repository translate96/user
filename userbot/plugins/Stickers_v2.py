...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "No Name Set Yet, Check @Yozmelar"
...
async def _(event):
    ...
    file_ext_ns_ion = "@Yozmelar_Sticker.png"
    ...
    if is_a_s:
        ...
        if userid == 1111847352:
            packshortname = "Yozmelar_animated"
        else:
...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        file_caption = "https://t.me/dardlivideo"
        if is_a_s:
            file_ext_ns_ion = "tgs"
